export const WHO_WE_ARE_CONTENT = {
  ...
  description:
    "In our quest to create ‘great moments for everyone, everyday’, Majid Al Futtaim has enabled happiness in the lives of people from around the world. Find out more about who we are.Next.js provides powerful tools to build scalable applications quickly.",
...
export const PEOPLE_AND_CAREERS_CONTENT = {
  ...
  description:
    "At our core, we are a values-led organisation that is bold, passionate and together in all that we do – underpinned by a culture that is inspired by a dynamic, entrepreneurial spirit.",
  buttonName: "Explore the Journey",
};
